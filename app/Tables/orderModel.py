...
class Order(ModelBase):
    ...
    def __init__(self, order_num, order_package_num, address_id, order_status=0, order_logistics_company=None, order_logistics_num=None, package_id=None, user_id=None):
